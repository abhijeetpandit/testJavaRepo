...
public class DefaultDatePrefixCustomSequenceGeneratorDemo {
	public static void main(String[] args) {
		...
		CustomSequenceGenerator sequenceGenerator = (CustomSequenceGenerator) applicationContext.getBean("defaultDatePrefixCustomSequenceGenerator");
